      ...
      <View style={styles.headerContainer}>
       ...
       <ImageBackground source={AddBgImage} style={styles.backgroundImage}>
        ...
        <View style={styles.featuresBox}>
          <Image source={EyeSlash} style={styles.featuresImage} />
          <Text style={styles.boxTitle}>No Ads</Text>
          <Text style={styles.boxSubtitle}>Get rid of annoying 3rd party ads</Text>
        </View>
        ...
        <View style={styles.instructionRow}>
         <Text style={styles.instructionText}>
            <Text style={styles.redText}>Terms of Service</Text> <Text style={styles.whiteText}>and</Text> <Text style={styles.redText}>Community Guidelines</Text> <Text style={styles.whiteText}>apply</Text>
          </Text>
        </View>

         <View style={styles.instructionDetailsRow}>
          <Text style={styles.instructionTextDetails}>
           If you subscribe to Purr Plus with your Apple or Google account, you can only manage your subscription from your device. 
          </Text>
        </View>
